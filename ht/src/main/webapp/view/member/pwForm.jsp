...
<h3 style="margin-left: 20px;">비밀번호찾기</h3>
<div class="idform_content">
<form action="pw" method="post" class="idform_body">
  <table class="table" style="margin-left:auto;">
     <tr><th>아이디</th><td><input type="text" name="id"></td></tr>
     <tr><th>이메일</th><td><input type="text" name="email"></td></tr>
     <tr><th>전화번호</th><td><input type="text" name="tel"></td></tr>
     <tr><td colspan="2">
     <button type="submit" class="idform_submit"onclick="id()">비밀번호찾기</button>
     <button type="button" class="idform_submit"
      onclick="newjoin()">회원가입</button>
</td></tr>
  </table>   
</form></div></body></html>